...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("mode/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("mode/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("mode/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("mode/light.svg"));
        }
    }
    ...
    private class LightDarkModeLayout implements LayoutManager {
        ...
        public Dimension preferredLayoutSize(Container parent) {
            synchronized (parent.getTreeLock()) {
                return new Dimension(5, buttonDark.getPreferredSize().height + 0);
            }
        }
